...
$root.message = (function() {
    ...
    message.MSGPacketID = (function() {
        ...
        values[valuesById[3005] = "PACKET_CS_CHATMSG"] = 3005;
        values[valuesById[3006] = "PACKET_SC_CHATMSG"] = 3006;
        return values;
    })();
    ...
    message.CSChatMsg = (function() {
        ...
        CSChatMsg.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.message.CSChatMsg();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
    ...
    message.SCChatMsg = (function() {
        ...
        SCChatMsg.prototype.Pos = 0;
        SCChatMsg.prototype.Content = "";
        SCChatMsg.prototype.MsgType = 0;
        SCChatMsg.prototype.Timestamp = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        SCChatMsg.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.message.SCChatMsg();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
