...
export  class MD5{
    ...
    let str2 = this.Utf8Encode(str);

 


    x = this.ConvertToWordArray(str2);
    ...
    public static RotateLeft(lValue:number, iShiftBits:number):number{
        return (lValue<<iShiftBits) | (lValue>>>(32-iShiftBits));
    }

    public static AddUnsigned(lX:number,lY:number):number {
    ...
    public static I(x:number,y:number,z:number):number { 
        return (y ^ (x | (~z))); 
    }


    public static FF(a:number,b:number,c:number,d:number,x:number,s:number,ac:number):number {
    ...
    public static GG(a:number,b:number,c:number,d:number,x:number,s:number,ac:number):number {
    ...
    public static HH(a:number,b:number,c:number,d:number,x:number,s:number,ac:number):number {
    ...
    public static II(a:number,b:number,c:number,d:number,x:number,s:number,ac:number):number {
    ...
    public static ConvertToWordArray(string:string):number[]{
    ...
    public static WordToHex(lValue:number):string {
    ...
    public static Utf8Encode(string:string):string {
