...
$root.server = (function() {
    ...
    server.DB_GameFree = (function() {
        ...
        DB_GameFree.prototype.JackpotRatio = 0;
        DB_GameFree.prototype.JackpotMin = 0;
        ...
        DB_GameFree.encode = function encode(m, w) {
            ...
            if (m.JackpotRatio != null && Object.hasOwnProperty.call(m, "JackpotRatio"))
                w.uint32(392).int32(m.JackpotRatio);
            if (m.JackpotMin != null && Object.hasOwnProperty.call(m, "JackpotMin"))
                w.uint32(400).int32(m.JackpotMin);
            return w;
        };
        ...
        DB_GameFree.decode = function decode(r, l) {
            ...
            while (r.pos < c) {
                ...
                case 48:
                    ...
                    break;
                case 49:
                    m.JackpotRatio = r.int32();
                    break;
                case 50:
                    m.JackpotMin = r.int32();
                    break;
                default:
                    r.skipType(t & 7);
                    break;
    ...
    server.DB_IceAgeCardLib = (function() {

        function DB_IceAgeCardLib(p) {
            this.Params = [];
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
        ...
        DB_IceAgeCardLib.prototype.Id = 0;
        DB_IceAgeCardLib.prototype.ModeName = "";
        DB_IceAgeCardLib.prototype.ModeType = 0;
        DB_IceAgeCardLib.prototype.Params = $util.emptyArray;

        DB_IceAgeCardLib.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.Id != null && Object.hasOwnProperty.call(m, "Id"))
                w.uint32(8).int32(m.Id);
            if (m.ModeName != null && Object.hasOwnProperty.call(m, "ModeName"))
                w.uint32(18).string(m.ModeName);
            if (m.ModeType != null && Object.hasOwnProperty.call(m, "ModeType"))
                w.uint32(24).int32(m.ModeType);
            if (m.Params != null && m.Params.length) {
                w.uint32(34).fork();
                for (var i = 0; i < m.Params.length; ++i)
                    w.int32(m.Params[i]);
        ...
        DB_IceAgeCardLib.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.server.DB_IceAgeCardLib();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
        ...
        return DB_IceAgeCardLib;
    })();

    server.DB_IceAgeCardLibArray = (function() {

        function DB_IceAgeCardLibArray(p) {
            this.Arr = [];
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
        ...
        DB_IceAgeCardLibArray.prototype.Arr = $util.emptyArray;

        DB_IceAgeCardLibArray.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.Arr != null && m.Arr.length) {
                for (var i = 0; i < m.Arr.length; ++i)
                    $root.server.DB_IceAgeCardLib.encode(m.Arr[i], w.uint32(10).fork()).ldelim();
            }
            return w;
        };

        DB_IceAgeCardLibArray.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.server.DB_IceAgeCardLibArray();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
                    if (!(m.Arr && m.Arr.length))
                        m.Arr = [];
                    m.Arr.push($root.server.DB_IceAgeCardLib.decode(r, r.uint32()));
                    break;
                default:
                    r.skipType(t & 7);
                    break;
        ...
        return DB_IceAgeCardLibArray;
    })();

    server.DB_IceAgeElementRate = (function() {

        function DB_IceAgeElementRate(p) {
            this.Params = [];
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
        ...
        DB_IceAgeElementRate.prototype.Id = 0;
        DB_IceAgeElementRate.prototype.ModeName = "";
        DB_IceAgeElementRate.prototype.ModeType = 0;
        DB_IceAgeElementRate.prototype.Params = $util.emptyArray;

        DB_IceAgeElementRate.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.Id != null && Object.hasOwnProperty.call(m, "Id"))
                w.uint32(8).int32(m.Id);
        ...
        DB_IceAgeElementRate.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.server.DB_IceAgeElementRate();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
        ...
        return DB_IceAgeElementRate;
    })();

    server.DB_IceAgeElementRateArray = (function() {

        function DB_IceAgeElementRateArray(p) {
            this.Arr = [];
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
        ...
        DB_IceAgeElementRateArray.prototype.Arr = $util.emptyArray;

        DB_IceAgeElementRateArray.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.Arr != null && m.Arr.length) {
                for (var i = 0; i < m.Arr.length; ++i)
                    $root.server.DB_IceAgeElementRate.encode(m.Arr[i], w.uint32(10).fork()).ldelim();
            }
            return w;
        };

        DB_IceAgeElementRateArray.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.server.DB_IceAgeElementRateArray();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
                    if (!(m.Arr && m.Arr.length))
                        m.Arr = [];
                    m.Arr.push($root.server.DB_IceAgeElementRate.decode(r, r.uint32()));
                    break;
                default:
                    r.skipType(t & 7);
                    break;
        ...
        return DB_IceAgeElementRateArray;
    })();
    ...
    server.DB_MatchRank = (function() {

        function DB_MatchRank(p) {
            this.RankStar = [];
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
        ...
        DB_MatchRank.prototype.Id = 0;
        DB_MatchRank.prototype.RankStar = $util.emptyArray;

        DB_MatchRank.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.Id != null && Object.hasOwnProperty.call(m, "Id"))
                w.uint32(8).int32(m.Id);
            if (m.RankStar != null && m.RankStar.length) {
                w.uint32(18).fork();
                for (var i = 0; i < m.RankStar.length; ++i)
                    w.int32(m.RankStar[i]);
                w.ldelim();
            }
            return w;
        };

        DB_MatchRank.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.server.DB_MatchRank();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
                    ...
                    break;
                case 2:
                    if (!(m.RankStar && m.RankStar.length))
                        m.RankStar = [];
                    if ((t & 7) === 2) {
                        var c2 = r.uint32() + r.pos;
                        while (r.pos < c2)
                            m.RankStar.push(r.int32());
                    } else
                        m.RankStar.push(r.int32());
                    break;
                default:
    ...
    server.DB_MatchRankArray = (function() {

        function DB_MatchRankArray(p) {
            this.Arr = [];
            if (p)
                for (var ks = Object.keys(p), i = 0; i < ks.length; ++i)
                    if (p[ks[i]] != null)
        ...
        DB_MatchRankArray.prototype.Arr = $util.emptyArray;

        DB_MatchRankArray.encode = function encode(m, w) {
            if (!w)
                w = $Writer.create();
            if (m.Arr != null && m.Arr.length) {
                for (var i = 0; i < m.Arr.length; ++i)
                    $root.server.DB_MatchRank.encode(m.Arr[i], w.uint32(10).fork()).ldelim();
            }
            return w;
        };

        DB_MatchRankArray.decode = function decode(r, l) {
            if (!(r instanceof $Reader))
                r = $Reader.create(r);
            var c = l === undefined ? r.len : r.pos + l, m = new $root.server.DB_MatchRankArray();
            while (r.pos < c) {
                var t = r.uint32();
                switch (t >>> 3) {
                case 1:
                    if (!(m.Arr && m.Arr.length))
                        m.Arr = [];
                    m.Arr.push($root.server.DB_MatchRank.decode(r, r.uint32()));
                    break;
                default:
                    r.skipType(t & 7);
                    break;
    ...
    server.DB_SlotRateWeight = (function() {
        ...
        DB_SlotRateWeight.prototype.GameFreeId = 0;
        DB_SlotRateWeight.prototype.Pos = 0;
    ...
    server.WGDestroyScene = (function() {
        ...
        WGDestroyScene.prototype.MatchStop = false;
        ...
        WGDestroyScene.encode = function encode(m, w) {
            ...
            if (m.MatchStop != null && Object.hasOwnProperty.call(m, "MatchStop"))
                w.uint32(24).bool(m.MatchStop);
            return w;
        };
    ...
    server.GWPlayerLeave = (function() {
        ...
        GWPlayerLeave.prototype.MatchStop = false;
    ...
    server.WGResetCoinPool = (function() {
        ...
        WGResetCoinPool.prototype.Value = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
